...
public class About_QucikPay extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.about_quickpay);
...
//                onBackPressed();
                startActivity(new Intent(About_QucikPay.this, MainActivity.class));
                finish();
                return true;
