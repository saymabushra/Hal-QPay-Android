...
public class KycUpdateNomineeInfo extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kyc_update_nominee_info);
        checkOs();
        initUI();
    }
    ...
    private void initUI() {
        ...
        mEditTextNomineeName.requestFocus();
        ...
        mEditTextNomineeName.setText(GlobalData.getStrNomineeName());
        mEditTextNomineeMobileNumber.setText(GlobalData.getStrNomineePhNo());
        mEditTextRelation.setText(GlobalData.getStrNomineeRelation());
        mEditTextPercent.setText(GlobalData.getStrNomineePercentage());
        mEditTextRemark.setText(GlobalData.getStrNomineeRemarks());
...
//                disableUiComponentAfterClick();
                try {
                    ...
                    mStrEncryptNomineeName = encryption.Encrypt(mEditTextNomineeName.getText().toString(), GlobalData.getStrSessionId());
                    mStrEncryptNomineeMobileNumber = encryption.Encrypt(mEditTextNomineeMobileNumber.getText().toString(), GlobalData.getStrSessionId());
                    mStrEncryptRelation = encryption.Encrypt(mEditTextRelation.getText().toString(), GlobalData.getStrSessionId());
                    mStrEncryptPercent = encryption.Encrypt(mEditTextPercent.getText().toString(), GlobalData.getStrSessionId());
                    ...
                    mProgressDialog = ProgressDialog.show(KycUpdateNomineeInfo.this, null, "Processing request...", false, true);
                                    ...
                                    try {
                                        if (mProgressDialog != null && mProgressDialog.isShowing()) {
                                            ...
                                            if (mStrServerResponse.equalsIgnoreCase("Update")) {
                                                ...
                                                //####################### Show Dialog ####################
                                                //####################### Show Dialog ####################
                                                AlertDialog.Builder myAlert = new AlertDialog.Builder(KycUpdateNomineeInfo.this);
                                                myAlert.setMessage("Successfully save Nominee info.");
                                                myAlert.setNegativeButton(
                                                        "OK",
                                                        new DialogInterface.OnClickListener() {
                                                            public void onClick(DialogInterface dialog, int id) {
                                                                dialog.cancel();
                                                                startActivity(new Intent(KycUpdateNomineeInfo.this, KycPreviewNomineeInfo.class));
                                                                finish();
                                                            }
                                                        });
    ...
    private void checkInternet() {
        if (isNetworkConnected()) {
            ...
            disableUiComponents();
            AlertDialog.Builder mAlertDialogBuilder = new AlertDialog.Builder(KycUpdateNomineeInfo.this);
...
//                clearDataFromGlobal();
//                Intent intent = new Intent(KycUpdateNomineeInfo.this, Login.class)
