...
public class KycPreviewContactInfo extends AppCompatActivity implements View.OnClickListener {
    private EncryptionDecryption encryption = new EncryptionDecryption();
    private ProgressDialog mProgressDialog = null;


    // initialize all ui components
    private TextView mTextViewEmail, mTextViewMobileNumber;
    private Button mBtnUpdate;
    private TextView mTextViewShowServerResponse;
    private String mStrMasterKey, mStrAccountNumber, mStrPin, mStrEncryptAccountNumber, mStrEncryptPin, mStrServerResponse,strParamete;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kyc_preview_contact_info);
        checkOs();
        initUI();
    }
    ...
    private void initUI() {
        ...
        mTextViewMobileNumber = findViewById(R.id.textViewMobile);
        mBtnUpdate = findViewById(R.id.btnKycUpdateContactInfo);
        mBtnUpdate.setOnClickListener(this);
        mTextViewShowServerResponse = findViewById(R.id.textViewKycUpdateContactInfoShowServerResponse);
    ...
    public void onClick(View v) {
        if (v == mBtnUpdate) {
            startActivity(new Intent(KycPreviewContactInfo.this, KycUpdateContactInfo.class));
            finish();
...
//                    mProgressDialog = ProgressDialog.show(KycPreviewContactInfo.this, null, "Processing request...", false, true);
...
//                                            //####################### Show Dialog ####################
//                                            //####################### Show Dialog ####################
//                                            AlertDialog.Builder myAlert = new AlertDialog.Builder(KycPreviewContactInfo.this);
...
//                                                            startActivity(new Intent(KycPreviewContactInfo.this, Login.class));
//                                                        }
//                                                    });
        ...
        if (isNetworkConnected()) {
            ...
            try {
                ...
                if (mStrServerResponse.equalsIgnoreCase("No Data Found")) {
                    ...
                    mTextViewEmail.setText(strEmail);
                    mTextViewMobileNumber.setText(strMobileNumber);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                startActivity(new Intent(KycPreviewContactInfo.this, Kyc.class));
                finish();
                return true;
            case R.id.actionRewardpoint:
//                clearDataFromGlobal();
//                Intent intent = new Intent(KycPreviewContactInfo.this, Login.class)
